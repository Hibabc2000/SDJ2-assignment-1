...
public class Thermometer implements Runnable, PropertyChangeListener
{
  ...
  public Thermometer(MainModel mainModel, String id, double temperature, int distance)
  {
  ...
  @Override public void run()
  {
    while (true)
    {
      //      Default value of external temperature is 10
      externalTemperature(externalTemperature,-10,25);
